...
def get_args():
    ...
    parser.add_argument('--model', default='resnet18', choices=['small', 'large', 'resnet18', 'resnet50', 'wideresnet'])
    parser.add_argument('--l2', default=0, type=float)
    parser.add_argument('--l1', default=0, type=float)
    parser.add_argument('--batch-size', default=128, type=int)
    parser.add_argument('--batch-size-test', default=128, type=int)
    parser.add_argument('--data-dir', default='../00_data', type=str)
    ...
    ## lr-max == 0.1 for sgd; lr-max == 0.001 for adam
    ...
    parser.add_argument('--fname', default='cifar10', type=str)
...
def main():
    args = get_args()
    if args.attack == 'none':
        args.fname += '/none/' + args.model 
    else:
        args.fname += '/' + args.norm + '/' + args.model
    ...
    proxy = models.get_model(args.model)
    ...
    if args.model == 'small' or args.model == 'large':
        opt = torch.optim.Adam(params, lr=args.lr_max, weight_decay=5e-4)
    elif args.model == 'resnet18' or args.model == 'resnet50' or args.model == 'wideresnet':
        opt = torch.optim.SGD(params, lr=args.lr_max, momentum=0.9, weight_decay=5e-4)
    else:
        raise ValueError('args.model is not specified correctly')
